...
public class QuanLyDichVuPanel extends JPanel implements ActionListener {
	...
	private List<Phong> listEmptyRooms = new ArrayList<>();
	private List<Phong> listBookedRooms = new ArrayList<>();
	...
	private void refreshRoomList() {
		// TODO Auto-generated method stub
		try {
			this.listRooms = phongDAO.getAllPhongs();
			this.listEmptyRooms = phongDAO.getAllEmptyPhongs();
